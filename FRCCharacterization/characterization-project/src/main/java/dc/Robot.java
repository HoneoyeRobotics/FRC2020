...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    WPI_VictorSPX leftMotor1 = new WPI_VictorSPX(27);

    WPI_VictorSPX rightMotor1 = new WPI_VictorSPX(25);

    SpeedController[] leftMotors = new SpeedController[1];
    leftMotors[0] = new WPI_VictorSPX(28);

    SpeedController[] rightMotors = new SpeedController[1];
    rightMotors[0] = new WPI_VictorSPX(26);
